...
class F_16env(gym.Env):
    def __init__(self):
        ...
        self.init_state=[250,0,0,0,0,np.pi,0,0,0,10000,10000,10000,9]
    ...
    def calculate_done(self):
        self.count+=1
        done=False if self.count<100 and self.distance>100 else True
        return done
    ...
    def reset(self):
        ...
        return [zip(self.init_state[10,9,11]),np.pi,0,0,0,0,np.deg2rad(135),0]
...
def main():
    ...
    target_update=10
    buffer_size=10000
    minimal_size=50#minimal_size必须大于batch_size
    batch_size=32
